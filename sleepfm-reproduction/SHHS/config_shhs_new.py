...
PATH_TO_PROCESSED_DATA = "/ssd/kdpark/sleepfm-codebase/shhs_segments_125/X_EOG_diff"
...
EMBED_SAVE_PATH = "/ssd/kdpark/sleepfm-codebase/outputs_shhseog/my_run/embeddings"
...
ALL_CHANNELS = ['SaO2', 'H.R.', 'EEG(sec)', 'ECG', 'EMG', 'EEG', 'THOR RES', 'ABDO RES', 'POSITION', 'LIGHT', 'EOG']

CHANNEL_DATA = {
    "Respiratory": ["THOR RES", "ABDO RES", "SaO2"],
    "Sleep_Stages": ["EEG", "EEG(sec)", "EMG", "EOG"],
    "EKG": ["ECG"],
}
